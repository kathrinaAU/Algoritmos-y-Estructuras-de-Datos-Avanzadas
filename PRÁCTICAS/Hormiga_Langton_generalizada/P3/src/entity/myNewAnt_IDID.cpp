...
myNewAnt_IDID::myNewAnt_IDID(){}

myNewAnt_IDID::~myNewAnt_IDID(){}

myNewAnt_IDID::myNewAnt_IDID(myBoard &b)
    :myAnt(b)
{
    muerte_id = '1';
    id = '4';
	...
	mColorMap.push_back(pair<char,char>('y','I'));
	mColorMap.push_back(pair<char,char>('z','D'));
}

ostream& myNewAnt_IDID::ver(ostream &os){
...
char myNewAnt_IDID::movimiento(char color){
...
int myNewAnt_IDID::findInColorMap(char color){
	int pos = -1;
...
char myNewAnt_IDID::setNewDirection(char color){
	char new_color;
