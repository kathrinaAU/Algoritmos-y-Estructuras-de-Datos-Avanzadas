...
myNewAnt_DIDI::myNewAnt_DIDI(){}

myNewAnt_DIDI::~myNewAnt_DIDI(){}

myNewAnt_DIDI::myNewAnt_DIDI(myBoard &b)
    :myAnt(b)
{
    muerte_id = '1';
    id = '3';
    mColorMap.push_back(pair<char,char>(' ','D'));
	mColorMap.push_back(pair<char,char>('a','I'));
	mColorMap.push_back(pair<char,char>('e','D'));
	mColorMap.push_back(pair<char,char>('i','I'));
}

ostream& myNewAnt_DIDI::ver(ostream &os){
...
char myNewAnt_DIDI::movimiento(char color){
...
int myNewAnt_DIDI::findInColorMap(char color){
	int pos = -1;
...
char myNewAnt_DIDI::setNewDirection(char color){
	char new_color;
